...
class OctotweetPlugin(octoprint.plugin.EventHandlerPlugin,
    ...
    def get_settings_restricted_paths(self):
        ...
        return dict(never=[["events", "test"]],
                    admin=[["consumer_key"], ["consumer_secret"], ["access_token"], ["access_token_secret"], ['script_before'], ['script_after']])
...
#                media = api.media_upload(snapshot)
